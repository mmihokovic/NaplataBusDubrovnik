...
{
    public class SubscriberCheckInTicket : IPrintObject
    {
        private Ticket ticket;

        public SubscriberCheckInTicket(Ticket ticket)
        {
            this.ticket = ticket;
        }
        ...
        public bool Print()
        {
            ...
            Shared.Printer.AddTextLine("Vrsta karte: ", 0, 3, 40, 620);
            Shared.Printer.SetJustification("center");
            Shared.Printer.AddTextLine(ticket.TicketType, 0, 3, 40, 670);
            Shared.Printer.SetJustification("left");
            Shared.Printer.AddBarCode(ticket.LicencePlates, 720);
